...
if ($_POST['sub']):
    ...
    if (empty($Bill) || empty($Office) || empty($Registry) || empty($Administrator) || empty($mobile) || empty($Company) || empty($price)) {
...
<td style=' border: 1px solid #ffffff;  font-family: tahoma;'>$    $Administrator = filter_var($_POST['Administrator'], FILTER_SANITIZE_STRING);
</td>
    </tr>      
    <tr>
...
<div class="form-group password-field">
        <div class="input-group">
    <input required  class="form-control" name="mobile" type="date"
    placeholder=" التاريخ">
        </div>
    </div>
	<div class="form-group password-field">
