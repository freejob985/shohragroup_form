...
if ($_POST['sub']):
    ...
    $password = filter_var($_POST['Registry'], FILTER_SANITIZE_STRING);
    $subject = filter_var($_POST['Administrator'], FILTER_SANITIZE_STRING);
    $date = filter_var($_POST['date'], FILTER_SANITIZE_STRING);
    $time = filter_var($_POST['time'], FILTER_SANITIZE_STRING);
    $msg = filter_var($_POST['msg'], FILTER_SANITIZE_STRING);
    if (empty($name) || empty($phone) || empty($email) || empty($subject) || empty($date) || empty($time) || empty($msg)) {
...
<td style=' border: 1px solid #ffffff;  font-family: tahoma;'>$time </td>
    </tr>
        <tr>
<td style=' width: 100px; text-transform: uppercase; padding: 1%; border: 1px solid #ffffff; font-family: tahoma; '>الرسالة</td>
<td style=' border: 1px solid #ffffff;  font-family: tahoma;'>$msg </td>
    </tr>
    </table>";
...
<div class="form-group password-field">
        <div class="input-group">
    <input required  class="form-control" name="password" type="phone"
    placeholder=" الجوال">
        </div>
    </div>
<div class="form-group password-field">
        <div class="input-group">
    <input required  class="form-control" name="password" type="date"
    placeholder=" التاريخ">
        </div>
    </div>
	<div class="form-group password-field">
	...
	<div class="form-group password-field">
        <div class="input-group">
    <input required  class="form-control" name="password" type="number"
 ...
 <textarea style="width:100%;background:#fafafa;height:100px;"></textarea>
    ...
    <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label" for="cb1">أقر بأن جميع البيانات صحيحة
            ...
            <div>
                <button class="btn btn-primary btn-block">أرسال</button>
            </div>
            <div class="text-center">
			</br>
