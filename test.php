...
<form action="/ar/applyastrainer" class="form-horizontal" enctype="multipart/form-data" method="post" role="form" novalidate="novalidate"><input name="__RequestVerificationToken" type="hidden" value="PfxBs8jyHbAxRg-ZPGYSHEl5dvl2N373UbXmY5G9d3a4dfzmvfRx2EJhmnSsi2yOtBbG0bp93geKGxbFreU-pQ54QG50pqV6bnVlNYtpiqY1"><div class="validation-summary-valid alert alert-danger col-sm-offset-3 col-sm-6" data-valmsg-summary="true"><ul><li style="display:none"></li>
</ul></div> <div class="col-sm-12 mb-25">
<div class="row">
<div class="col-sm-6">
...
<select class="form-control valid" id="Prefix" name="Prefix" aria-invalid="false"><option value="السيد">السيد</option>
...
<select class="form-control" id="TrainerCountry" name="TrainerCountry"><option value="">اختر الدولة</option>
...
<select class="form-control" id="TrainerCity" name="TrainerCity"><option value="">اختر المدينة</option>
</select>
</div>
...
<select class="form-control" id="TrainerNationality" name="TrainerNationality"><option value=""></option>
...
<select class="form-control" id="IdType" name="IdType"><option value=""></option>
...
<select class="form-control" data-val="true" data-val-required="تعبئة 'الإنجليزية كتابة' مطلوب" id="EnglishWritten" name="EnglishWritten"><option value=""></option>
...
<select class="form-control" data-val="true" data-val-required="تعبئة 'الإنجليزية محادثة' مطلوب" id="EnglishSpoken" name="EnglishSpoken"><option value=""></option>
<option value="NativeLanguage">اللغة الأم</option>
<option value="Excellent">ممتازة</option>
<option value="VeryGood">جيدة جدا</option>
<option value="Good">جيدة</option>
...
<select class="form-control" data-val="true" data-val-required="تعبئة 'العربية كتابة' مطلوب" id="ArabicWritten" name="ArabicWritten"><option value=""></option>
<option value="NativeLanguage">اللغة الأم</option>
<option value="Excellent">ممتازة</option>
<option value="VeryGood">جيدة جدا</option>
<option value="Good">جيدة</option>
...
<select class="form-control" data-val="true" data-val-required="تعبئة 'العربية محادثة' مطلوب" id="ArabicSpoken" name="ArabicSpoken"><option value=""></option>
<option value="NativeLanguage">اللغة الأم</option>
<option value="Excellent">ممتازة</option>
<option value="VeryGood">جيدة جدا</option>
<option value="Good">جيدة</option>
...
<strong>إختر الفئات اللتي تختص فيها: <span class="text-danger">*</span></strong>
</p>
<div class="col-sm-12">
...
<div class="g-recaptcha" data-sitekey="6Lcn2BETAAAAAFXAEhc1lgMcIsL6tqMCBe6UhuGt"><div style="width: 304px; height: 78px;"><div><iframe src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=6Lcn2BETAAAAAFXAEhc1lgMcIsL6tqMCBe6UhuGt&amp;co=aHR0cHM6Ly93d3cuYWN0a3NhLmNvbTo0NDM.&amp;hl=ar&amp;v=5mNs27FP3uLBP3KBPib88r1g&amp;size=normal&amp;cb=as8lr95myioi" width="304" height="78" role="presentation" name="a-6cjumjo6aahd" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe __idm_frm__="266" style="display: none;"></iframe></div>
</div>
